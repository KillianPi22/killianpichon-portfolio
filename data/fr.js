...
window.KP_FR = {
  ui: {
    ...
    'Floating': 'Flottant',
    'With a mouse, the frame follows gently, then settles.': 'À la souris, le cadre suit doucement, puis revient se poser.',
    'Device tilt': 'Inclinaison',
    'Enable tilt': 'Activer l’inclinaison',
    'Disable tilt': 'Désactiver l’inclinaison',
    'Recenter': 'Recentrer',
    'Permission…': 'Autorisation…',
    'On a phone or tablet, enable tilt in your reading position. Sensor data stays on your device.': 'Sur téléphone ou tablette, active l’inclinaison dans ta position de lecture. Les données restent sur l’appareil.',
    'Tilt is disabled while reduced motion is enabled.': 'L’inclinaison est désactivée avec la réduction des mouvements.',
    'Tilt requires HTTPS on a phone or tablet.': 'L’inclinaison nécessite une connexion HTTPS sur téléphone ou tablette.',
    'Tilt is unavailable in this browser.': 'L’inclinaison n’est pas disponible dans ce navigateur.',
    'Choose Floating to try device tilt.': 'Choisis Flottant pour essayer l’inclinaison.',
    'Hold your reading position: the next sensor reading recenters the frames.': 'Garde ta position de lecture : le prochain mouvement recentre les cadres.',
    'Allow motion access if your browser asks.': 'Autorise l’inclinaison si ton navigateur le demande.',
    'Motion access was denied by the browser. On iPhone, fully close Safari or Chrome, reopen this page and try again. Choose “Allow” if prompted.': 'Autorisation refusée par le navigateur. Sur iPhone, ferme complètement Safari ou Chrome, rouvre ce lien puis réessaie. Choisis « Autoriser » si une demande apparaît.',
    'Hold your reading position while the sensor is detected.': 'Garde ta position de lecture pendant la détection du capteur.',
    'Permission granted, but no sensor data received. Reload the page and try again in Safari or Chrome.': 'Autorisation accordée, mais aucune donnée du capteur reçue. Recharge la page puis réessaie dans Safari ou Chrome.',
    'Tilt is unavailable. The frames remain still.': 'L’inclinaison est indisponible. Les cadres restent stables au toucher.',
    'Sensor active. Tilt your device gently; Recenter adapts the effect to your reading position.': 'Capteur actif. Incline doucement l’appareil ; Recentrer adapte l’effet à ta position de lecture.',
    'Motion received. Visible frames follow device tilt; Recenter adapts the effect to your reading position.': 'Mouvement reçu. Les cadres visibles suivent l’inclinaison ; Recentrer adapte l’effet à ta position de lecture.',
    ...
    'Detailed case studies can be presented on request, subject to the applicable confidentiality agreements.':
      'Des études de cas détaillées peuvent être présentées sur demande, dans le respect des ententes de confidentialité.',
  ...
  projects: {
    ...
    cabotage: {
      ...
      roleTitle: 'Projet étudiant',
      desc: 'Une cabane de pêcheur au bord de la mer, conçue comme décor temps réel pour un tournage en production virtuelle chez MELS.',
      overview: 'Cabotage est mon projet de fin de formation intensive en Unreal Engine 5 et en production virtuelle au NAD. Le décor a été projeté pour un tournage chez MELS le 28 juin 2023. Le cahier des charges réunissait une cabane, du brouillard et un horizon marin, avec une cible de 60 images par seconde sur une NVIDIA RTX 2060 et un projet de moins de 30 Go. Le travail dépassait la scène numérique : il fallait la faire vivre avec un comédien, des accessoires physiques et l’éclairage du plateau.',
      role: 'Artiste d’environnement 3D — assemblage de scène, modélisation, commandes temps réel et compositing',
      contribution: ['Assemblage du décor côtier à partir d’assets Marketplace, Quixel et personnels.', 'Modélisation de la cabane modulaire et du phare, texturage du phare et intégration dans la scène.', 'Préparation d’une séquence par position de caméra pour activer les éléments utiles au cadre, et de commandes Blueprint pour les séquences caméra et les paramètres du décor pendant le tournage.', 'Essais de systèmes d’eau et choix d’un shader HLSL / Niagara sur le plateau pour limiter le coût en temps réel ; animation des éléments par des séquences à lecture automatique et un acteur Blueprint pour la bouée.', 'Préparation d’une animatique comme référence de jeu et d’ambiance, puis compositing et correction colorimétrique du montage final.'],
      contributionNote: 'Le décor associe mes propres créations à des assets existants. Le tournage était un exercice collectif avec un comédien, des mentors, des collègues de formation et l’équipe de MELS.',
      technicalChallenges: ['Le défi — faire cohabiter la cabane, le brouillard et la mer dans un budget temps réel limité, tout en gardant des réglages accessibles pour la caméra sur le plateau.', 'La réponse de production — organiser l’activation de la scène selon les positions de caméra et choisir un traitement de l’eau qui ne nécessitait pas de simulation complète pendant le tournage.', 'La distinction de production — le montage publié comprend aussi des rendus CG. Fluid Flux a servi à l’introduction et au générique, tandis que l’eau sur le plateau utilisait HLSL / Niagara ; le montage ne constitue donc pas une capture brute des performances de la scène temps réel.'],
      pipeline: ['Assemblage du décor et modélisation modulaire', 'Essais de systèmes d’eau et optimisation de la scène', 'Séquences caméra et commandes du décor en direct', 'Animatique de jeu et d’ambiance', 'Tournage en production virtuelle chez MELS', 'Rendus CG, compositing et correction colorimétrique'],
      impact: 'Les prises de vues en studio ont été enregistrées en une séance de deux heures. Le montage final, la décomposition du décor et l’animatique préparatoire documentent le projet de sa préparation au tournage.',
      creditsNote: 'André Comiré — comédien ; Rémi Lapierre — mentor Unreal ; Ifaz Matoub — conseiller généraliste 3D ; Vincent Ladouceur — mentor en production virtuelle ; Simon Girard — suivi de caméra ; Patrice Puiberneau — concepteur lumière et mentor ; Alexis Sénécal — assistant lumière ; Nicolas Fournier — directeur technique et cadreur chez MELS ; Jérémy B. Raymond — co-conception sonore ; Michel De Silva — making-of. Merci aussi à Pascal Lavallée, Guillaume Beauchamp, Aran Beik, Nicolas Lachance-Brais et Vivianne Proulx pour leur aide en optimisation, logistique, essais d’eau, mise au point et accessoires physiques ; à Élyz Bouchard pour le maquillage ; et à Frederic Vicaire pour ses conseils sur le plateau.',
      videoTitles: ['Cabotage — montage final', 'Cabotage — décomposition du décor', 'Cabotage — animatique de jeu'],
      galleryAlts: ['vue dans le moteur de l’intérieur de la cabane de pêcheur, avec un escalier en bois et une lampe allumée.', 'comédien et décor physique devant l’environnement projeté au Studio L de MELS 3.', 'vue d’ensemble du paysage côtier et de l’océan dans Unreal Engine.', 'phare texturé et intégré au décor côtier.', 'modèle du phare et ses composants séparés.', 'cabane de pêcheur modulaire assemblée sur la côte dans Unreal Engine.', 'modules de murs, de toiture et d’escalier utilisés pour construire la cabane de pêcheur.', 'commandes Blueprint pour changer de séquence caméra et régler la scène pendant le tournage.'],
      externalLabel: 'Voir le projet sur ArtStation'
    },
    celestia: {
    ...
    melanie: {
      ...
      contribution: ['Reprise du sculpt des chevaux de carrousel, puis préparation des versions haute et basse résolution et bake de leurs normal maps.', 'Texturing des chevaux dans Substance Painter, en adaptant des matériaux intelligents et des filtres, puis en peignant à la main les zones restantes.', 'Retouche dans Blender de modèles de buissons sur mesure afin que leurs formes correspondent aux références visuelles de l’environnement.', 'Modélisation dans Cinema 4D d’un kit d’assets modulaires à partir de références architecturales du palais Esterházy, puis préparation des éléments pour l’assemblage de l’environnement dans Unreal Engine.', 'Modélisation de la boîte en bois et adaptation de la balançoire à bascule.', 'Assemblage et préparation des environnements pour la lecture en direct, en gardant la continuité visuelle d’un décor de livre d’images à l’autre.', 'Préparation et optimisation des scènes pour la répétabilité qu’exige une production en tournée.'],
