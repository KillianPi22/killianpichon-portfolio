...
window.KP_FR = {
  ui: {
    ...
    'I build 3D assets and environments for real-time productions and follow them through to engine integration: modeling, sculpting, texturing, optimization and scene assembly in Unreal. Based in Montréal, I work on immersive projects where the image has to hold at architectural scale, which means shaping both the visuals and the workflow that carries them — asset preparation, real-time performance and the reviews a team needs before installation.':
      'Je fabrique des ressources 3D et des environnements pour la production temps réel, et je les accompagne jusqu’à l’intégration moteur : modélisation, sculpture, texturing, optimisation et assemblage de scène dans Unreal. Basé à Montréal, je travaille sur des projets immersifs où l’image doit tenir à l’échelle architecturale, ce qui demande de façonner autant les visuels que le flux de travail qui les porte — préparation des ressources, performances temps réel et revues dont une équipe a besoin avant l’installation.',

    /* Experience : intitules de poste, lieux, resumes */
    'Co-founded an independent collective for immersive cinema and real-time storytelling with Pascal Lavallé and Nicolas Lachance-Brais, now a group of five. I set up the structure we use to coordinate scenes, shared assets and technical decisions, and I take part in the artistic and technical choices and in following projects from early studies through fulldome delivery. We work as peers, each of us driving where availability and experience allow, and creative choices stay connected to how an audience experiences the work inside the dome.':
      'Cofondation, avec Pascal Lavallé et Nicolas Lachance-Brais, d’un collectif indépendant consacré au cinéma immersif et à la narration temps réel, aujourd’hui à cinq. J’ai mis en place la structure qui nous sert à coordonner les scènes, les ressources partagées et les décisions techniques, et je participe aux choix artistiques et techniques comme au suivi des projets, des premières études jusqu’à la livraison fulldôme. Nous avançons entre pairs, chacun menant là où sa disponibilité et son expérience le permettent, en gardant les choix créatifs liés à la façon dont le public vit l’oeuvre sous le dôme.',
